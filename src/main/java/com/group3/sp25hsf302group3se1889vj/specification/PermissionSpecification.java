...
import com.group3.sp25hsf302group3se1889vj.dto.filter.PermissionFilterDTO;
...
public class PermissionSpecification {
    public static Specification<Permission> filterPermission(PermissionFilterDTO filterDTO) {
