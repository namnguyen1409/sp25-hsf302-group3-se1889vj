...
import com.group3.sp25hsf302group3se1889vj.dto.filter.UserCouponFilterDTO;
...
public class UserCouponSpecification {
    public static Specification<UserCoupon> filterUserCoupon(UserCouponFilterDTO filterDTO) {
