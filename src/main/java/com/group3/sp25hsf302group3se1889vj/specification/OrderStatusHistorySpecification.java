...
import com.group3.sp25hsf302group3se1889vj.dto.filter.OrderStatusHistoryFilterDTO;
...
public class OrderStatusHistorySpecification {
    public static Specification<OrderStatusHistory> filterOrderStatusHistory(OrderStatusHistoryFilterDTO filterDTO) {
