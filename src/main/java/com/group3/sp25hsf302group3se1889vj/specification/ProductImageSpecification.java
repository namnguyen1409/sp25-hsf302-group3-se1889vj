...
import com.group3.sp25hsf302group3se1889vj.dto.filter.ProductImageFilterDTO;
...
public class ProductImageSpecification {
    public static Specification<ProductImage> filterProductImage(ProductImageFilterDTO filterDTO) {
