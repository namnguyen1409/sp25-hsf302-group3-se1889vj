...
var percentFreeShip = "";
var imgCartNo = "//theme.hstatic.net/200000690725/1001078549/14/cart_banner_image.jpg?v=666";
...
HRT.All = {
        ...
        function processCart(cart,xHasyPrice){
            if(cart) {
                ...
                if(cart.total_price/100 >= freeShipMin) {
                    percentFreeShip = '100%';
                    jQuery('.cart-shipping .cart-shipping__title').html('Báº¡n Ä‘Ã£ Ä‘Æ°á»£c <span class="free-ship">miá»…n phÃ­ váº­n chuyá»ƒn</span>')
                    ...
                    jQuery('.cart-shipping .cart-shipping__title').html('Báº¡n cáº§n mua thÃªm <span class="price">' + Haravan.formatMoney(freeShipMin*100 - cart.total_price, formatMoney) + '</span> Ä‘á»ƒ Ä‘Æ°á»£c <span class="free-ship">miá»…n phÃ­ váº­n chuyá»ƒn</span>');
                    jQuery('.cart-shipping .cart-shipping__bar .shipping-bar').css('width', percentFreeShip + '%');
    ...
    clone_item: function(product, i, xHasyPrice){
        ...
        if ( product.image == null ) {
            item_product.find('img').attr('src','//theme.hstatic.net/200000690725/1001078549/14/no_image.jpg?v=666').attr('alt', product.url);
        } else {
                ...
                var params = {
                    ...
                    success: function(line_item) {
                        ...
                        if (template.indexOf('cart') > -1) {
                            ...
                            var $info = '<div class="row"><div class="col-md-12 col-xs-12"><p class="jGowl-text">ÄÃ£ thÃªm vÃ o giá» hÃ ng thÃ nh cÃ´ng!</p></div><div class="col-md-4 col-xs-4"><a href="' + line_item['url'] + '"><img width="70px" src="' + image + '" alt="' + line_item['title'] + '"/></a></div><div class="col-md-8 col-xs-8"><div class="jGrowl-note"><a class="jGrowl-title" href="' + line_item['url'] + '">' + line_item['title'] +  '</a><ins>' + Haravan.formatMoney(line_item['price'], formatMoney) + '</ins></div></div></div>';
...
HRT.Main = {
    ...
    searchAutoHeader: function(){
        $('.ultimate-search').submit(function(e) {
            ...
            if(q.indexOf('script') > -1 || q.indexOf('>') > -1){
                alert('Tá»« khÃ³a cá»§a báº¡n cÃ³ chá»©a mÃ£ Ä‘á»™c háº¡i ! Vui lÃ²ng nháº­p láº¡i tá»« khÃ³a khÃ¡c');
                        ...
                        var params = {
                            ...
                            success: function(data) {
                                ...
                                if(giftExistInCart){
									...
									$('.boxinfo.p-count').html(data.item_count + ' sáº£n pháº©m');
									*/
                                        });
                                    }
                                }
                                ...
                                success:function(data){
                                    if($(data).find('#newsletter-success').length > 0){
                                        ...
                                        Swal.fire({
                                            ...
                                            title: "ÄÄƒng kÃ­ thÃ´ng tin thÃ nh cÃ´ng",
                                        ...
                                        $('.newsletter-form .newsletter-error').html('Äá»‹a chá»‰ email khÃ´ng há»£p lá»‡');
                                    }
                                },
                            })
                        });
                            ...
                            $.ajax({
                                ...
                                success:function(data){
                                    ...
                                    Swal.fire({
                                        ...
                                        customClass: "newsletter-form-success",
                                        title: "ÄÄƒng kÃ­ thÃ´ng tin thÃ nh cÃ´ng",
                                        html: '<p class="txt1">Cáº£m Æ¡n báº¡n Ä‘Ã£ Ä‘á»ƒ láº¡i thÃ´ng tin</p><p class="txt2">ChÃºng tÃ´i sáº½ liÃªn há»‡ vá»›i báº¡n trong thá»i gian sá»›m nháº¥t</p><p class="txt3">ThÃ´ng bÃ¡o sáº½ tá»± Ä‘á»™ng táº¯t sau <span></span> giÃ¢y...</p>',
                                        showConfirmButton: false,
                                        timer: 5000,
                                        timerProgressBar: true,
                                    }).then((result) => {
    ...
    copyCodeProdCoupon: function(){
        $(document).on('click', '.coupon-item .cp-btn', function(e){
            e.preventDefault();
            $('.coupon-item .cp-btn').html('Sao chÃ©p mÃ£').removeClass('disabled');
...
HRT.Index = {
    ...
    popoverLookbooks: function(){
        if ($('.popover-dot').length > 0){
            jQuery('.popover-dot[data-bs-toggle="popover"]').popover({
                html: true,
                animation: true,
                placement: function ( popover, trigger ){
                    var placement = jQuery( trigger ).attr( 'data-bs-placement' );
...
HRT.Product = {
    ...
    scrollSidebarBottom: function(){
        setTimeout(function(){
            var hActionTop = $('.product-tabs').offset().top - 500;
            var hActionTopMobile = $('.product-tabs').offset().top - 500;
            $(window).scroll(function() {
                if ($(window).width() > 768) {
                    ...
                    if (hActionTopMobile < $(this).scrollTop()){
                        $('.sidebar-action-bottom').addClass("is-show");
                    }
                    else{
                        $('.sidebar-action-bottom').removeClass("is-show");
    ...
    addCartStickyProduct: function(){
        $(document).on('change','#js-sitenav-combo .combo-select',function(){
            var i = $(this).val();
            var html = $('#product-app-combo .combo-info--content[data-combo-index="'+i+'"]').html();
            $('#js-sitenav-combo .combo-content').html(html);
        });

        $(document).on('click','#btn-promo',function(){
            var htmlSel = '<select class="combo-select form-control">';
            var html = '';
            $('#product-app-combo .combo-info--content').each(function(i){
                var title = $(this).find('.combo-content--name').html();
                htmlSel += '<option value="'+i+'" '+(i==0 ? 'selected' : '')+'>'+title+'</option>';
                var content = $(this).html();
                if(i == 0) {html += content;}
            });
            htmlSel += '</select>';
            $('#js-sitenav-combo .sitenav-content').html('<div class="combo-wrap"><div class="combo-formgroup form-group"><label>Chá»n combo: </label>'+htmlSel+'</div><div class="combo-content">'+html+'</div></div>');
            $('body').addClass('locked-scroll');
            $('#js-sitenav-combo').addClass('is-opened');
        });

        $(document).on('click','#add-to-cart-sticky',function(){
            /*if(window.innerWidth > 991) $('#add-to-cart').trigger('click');
			else $("html, body").animate({ scrollTop: $('.info-body').offset().top }, "slow");*/
            $("html, body").animate({ scrollTop: $('.info-body').offset().top });
        });
    },
            ...
            if($('.expandable-toggle .desc-content-js').height() > 230){
                ...
                seeMore.click(function() {
                    ...
                    if($(this).hasClass('show')) {
                        ...
                        $('.expandable-toggle__btn').removeClass('btn-viewmore').addClass('btn-closemore').find('.expandable-toggle__text').html('RÃºt gá»n ná»™i dung');
                        $(this).parent('.description-btn').addClass('is-show');
                    } else {
                        content_height.css("max-height","230px");
                        $('.expandable-toggle__btn').removeClass('btn-closemore').addClass('btn-viewmore').find('.expandable-toggle__text').html('Xem thÃªm ná»™i dung');
    ...
    render_items: function(result,iCombo,nCombo,currentId){
        ...
        $.each(nCombo,function(i,v){
            /* Kiá»ƒm tra giáº£m theo biáº¿n thá»ƒ tá»« app */
            ...
            htmlDetail +=	    	'<span class="combo--title">'+(v == currentId?'<strong>Báº¡n Ä‘ang xem: </strong> ':'')+dtQty+' x '+result[v].title;
            htmlDetail +=	    	'</span>';
            htmlDetail +=				'</div>';
            if (is_vrt_combo) {
            ...
            htmlDetail +=						'<div class="title">Vui lÃ²ng chá»n:</div>';
            htmlDetail +=					'</div>';
            ...
            if (result[v].option_size == 1) {
                ...
                var valueOption2 = "";
                //var sortResult = [result[v].options.find((item) => item.name === "MÃ u sáº¯c"),...result[v].options.filter((item) => item.name !== "MÃ u sáº¯c")]
                if(is_vrt_combo){
                    ...
                    result[v].options.forEach((op,index) => {
                        if(op.name == "MÃ u sáº¯c") indexOption = index;
                        htmlDetail +=				'<div class="select-option option'+ (index+1) +'" data-option="option'+(index+1)+'">';
                        if(op.value.length != 1){
            ...
            if(is_vrt_combo){
                ...
                htmlDetail +=	    	'<p class="combo-item--price"><span class="price-tt">Giáº£m cÃ²n: </span><span class="price-cb">'+Haravan.formatMoney(dtPrice*dtQty*100, formatMoney)+'</span>'+(vrt_combo.price > dtPrice?'<del>'+Haravan.formatMoney(vrt_combo.price*dtQty*100, formatMoney)+'</del>':'')+'</p>';
            }
            else{
                ...
                htmlDetail +=	    	'<p class="combo-item--price"><span class="price-tt">Giáº£m cÃ²n: </span><span class="price-cb">'+Haravan.formatMoney(dtPrice*dtQty*100, formatMoney)+'</span>'+(result[v].price > dtPrice?'<del>'+Haravan.formatMoney(result[v].price*dtQty*100, formatMoney)+'</del>':'')+'</p>';
            }
            htmlDetail +=	    	'</div>';
            htmlDetail +=		 		'</div>';
            htmlDetail +=	    	'</div>';
        ...
        htmlDetail +=						'<p class="txt1">Tá»•ng tiá»n: <span class="combo-total-price">'+Haravan.formatMoney(totalPriceCombo*100, formatMoney)+'</span></p>';
        htmlDetail +=						'<p class="txt2">Tiáº¿t kiá»‡m: <span class="combo-total-priceInit">'+Haravan.formatMoney(totalPriceInit*100 - totalPriceCombo*100, formatMoney)+'</span></p>';
        htmlDetail +=					'</div>'
        htmlDetail +=					'<button type="button" class="add-combo">ThÃªm '+nCombo.length+' vÃ o giá» hÃ ng</button>'
        htmlDetail +=	   		'</div>';
        htmlDetail +=	   '</div>';
        return htmlDetail;
    },
    ...
    updateInfoItemCombo: function(e,id,indexCombo,resulData){
        ...
        if(checkIsCombo){
            $(e).parents('.combo-item--detail').find('.combo-item--price').html('<span class="price-tt">Giáº£m cÃ²n:</span><span class="price-cb">'+ Haravan.formatMoney(HRT.Product.render_price(resulData,dataItemsCombo[indexCombo][id]).price*100, formatMoney)+'</span>' + '<del>'+ Haravan.formatMoney(resulData.price*100, formatMoney) +'</del>');
        }
        else{
    ...
    updatePriceTotalCombo: function(e,id,index,strValue,resulData){
        ...
        if(checkIsCombo){
            $(e).parents('.combo-info--content').find('.combo-item:not(.disabled)').each((i,v)=>{
                ...
                var parsrPrice = parseInt(itemPrice.replace(/â‚«/g, "").replace(/,/g, ""));
                var parsrPriceFirst = parseInt(itemPriceFirst.replace(/â‚«/g, "").replace(/,/g, ""));
            ...
            if(ind >= 0){
                ...
                $(this).parents('.combo-info--content').find('input').each(function(){
                    ...
                    if(numCombo == numCheck){
                        ...
                        $(this).parents('.combo-item').find('.combo-item--price').html('<span class="price-tt">Giáº£m cÃ²n: </span><span class="price-cb">' +Haravan.formatMoney(combo*qty*100, formatMoney)+'</span>'+htmlDel);
                    }
                    else{
                        checkIsCombo = false;
                ...
                $(this).parents('.combo-info--content').find('.add-combo').html('ThÃªm '+(numCheck == 1 ? '' : numCheck + ' ')+'vÃ o giá» hÃ ng');
            }
            //var parents = $(this).parents('.products-detail-js').attr('id');
            //var checkcount = $('#'+parents+' input[name="combo-option"]:checked').length;
            //$(this).parents('.combo-info--content').find('.add-combo').html('ThÃªm '+(checkcount == 1 ? '' : checkcount + ' ')+'vÃ o giá» hÃ ng');
        });
    },
    changeOptionFirstCombo: function(){
        jQuery(document).on('change','.combo-item--option [name="option1"]', function(e) {
            ...
            if(vrtSize == 1) {
                ...
                if(checkIsCombo){
                    $(this).parents('.combo-item--detail').find('.combo-item--price').html('<span class="price-tt">Giáº£m cÃ²n:</span><span class="price-cb">'+ Haravan.formatMoney(HRT.Product.render_price(resulData,dataItemsCombo[indexCombo][pro_id]).price*100, formatMoney)+'</span>' + '<del>'+ Haravan.formatMoney(resulData.price*100, formatMoney) +'</del>');
    ...
    clickAddCombo: function(){
        ...
        $(document).on('click','#js-sitenav-combo .add-combo',function(){
            var aItems = [];
            $(this).parents('.combo-content').find('input:checked').each(function(){
                var temp = {};
                temp.vid = $(this).val();
            ...
            HRT.Product.addCombo(0, aItems, function(){
                ...
                HRT.All.getCartModal(false);
                //HRT.All.sidenav_open($site_cart, '#js-sitenav-cart', 'js-current');
                $('#js-sitenav-combo').removeClass('is-opened');
                $('#js-sitenav-cart').addClass('is-opened');
            });
        });
...
HRT.Article = {
     ...
     */
            ...
            (function($) {
                var stringtemplate = $('<div id="table-content-container" class="table-of-contents"><div class="table-title"><div class="htitle">CÃ¡c ná»™i dung chÃ­nh<span class="toc_toggle">[<a class="icon-list" href="javascript:void(0)">áº¨n</a>]</span></div></div></div>');
...
HRT.Quickview = {
    ...
    submitPreorderQv: function(url){
        $('#modal-quickview form.contact-form').submit(function(e){
            e.preventDefault();
            var self = $(this);
            var vlTextbody = 'Ná»™i dung: '+$('textarea.product-body-val').val();
            var handlePr = window.location.origin + url;
            var vlTextPr = $('input.detailPr').val() + '\n' + 'Link sáº£n pháº©m: '+handlePr;
            var swatchSize = parseInt($('#add-item-form-qv .select-swatch .swatch').length);
            if(swatchSize == 1){
                var vlVariant = 'Biáº¿n thá»ƒ: '+$('.select-swatch .swatch').find('label.sd span').html();
            }
...
HRT.Cart = {
        ...
        if(promotionApp && promotionApp_name == 'app_buyxgety' || promotionApp_name == 'app_combo'){
            ...
            var params = {
                ...
                success: function(data) {
					...
					$('.count-cart').html( data.item_count + " sáº£n pháº©m");
					$('.count-holder .count').html(data.item_count );
					setTimeout(function(){
						$('.cart-ajloading').hide();
					},400);*/
    ...
    removeItemCart: function(t, url){
        var self = $(t)
        Swal.fire({
            title: "Báº¡n cháº¯c cháº¯n muá»‘n bá» sáº£n pháº©m nÃ y ra khá»i giá» hÃ ng?",
        ...
        $.when($.get('/cart.js')).then(function(result){
            if(result != null && result.attributes.hasOwnProperty('Delivery Time')){
                ...
                if(now > maxExist || maxExist - now < 45*60*1000  ){
                    $('.txt-time span').html('Chá»n thá»i gian');
    ...
    checkTimeAvailable: function(time){
        ...
        /* Check trong ngÃ y tá»« 8h Ä‘áº¿n 21h */
        var stillAvailable = true;
        /* Náº¿u nháº­p giá» báº¯t Ä‘áº§u ko nháº­n Ä‘Æ¡n vÃ  giá» báº¯t Ä‘áº§u má»Ÿ cá»­a */
        ...
        if(stillAvailable == false)	$('#btnCart-checkout').addClass('btntime-disable').html('ÄÃ£ ngÆ°ng nháº­n Ä‘Æ¡n hÃ´m nay');
    ...
    pickOptionTime: function(){
                ...
                if ($("#picktime_radio input[name='timeRadios']:checked").val() == 'timeNow') {
                    ...
                    if(startStop != null && endStop != null){
                        if( stillAvailable == false ){
                            $('#btnCart-checkout').addClass('btntime-disable').html('ÄÃ£ ngÆ°ng nháº­n Ä‘Æ¡n hÃ´m nay');
                        }
                        else{
                            ...
                            $.post('/cart/update.js',{ attributes: cartGet.attributes }).done(function(cart){
                                ...
                                if(cart.total_price > 0)	$('#btnCart-checkout').removeClass('btntime-disable').html('Thanh toÃ¡n');
                            });
                        }
                    }
                    else{
        ...
        $('#date_shipping').on('change',function(){
            ...
            if(dateNowVN == dateOrder){
                ...
                $('#btnCart-checkout').removeClass('btntime-disable').html('Thanh toÃ¡n');
            }
        });
    ...
    clickCheckoutCart: function(){
        $(document).on("click","#btnCart-checkout:not(.disabled)",function(e){
            ...
            var total_price = Number($('.summary-total span').html().replace(/\,/g,'').replace('â‚«',''));
            var a = $(this);
            ...
            if(Number(priceMin) <= total_price){
                ...
                if($('#checkbox-bill').is(':checked')){
                    var a = $(this);
                    swal.fire({
                        title: "Báº¡n cÃ³ muá»‘n xuáº¥t hÃ³a Ä‘Æ¡n?",
                        text: "HÃ£y kiá»ƒm tra láº¡i thÃ´ng tin hÃ³a Ä‘Æ¡n cá»§a mÃ¬nh tháº­t chÃ­nh xÃ¡c!",
                        icon: "warning",
                        showCancelButton: true,
                            ...
                            $('#cartformpage .val-f').each(function(){
                                if($(this).val() === ''){
                                    ...
                                    if($(this).siblings('span.text-danger').length == 0)
                                        $(this).after('<span class="text-danger">Báº¡n khÃ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng trÆ°á»ng nÃ y</span>');
                                }else{
                                ...
                                if($(this).hasClass('val-n') && $(this).val().trim().length<10){
                                    f = false;
                                    if($(this).siblings('span.text-danger').length == 0)
                                        $(this).after('<span class="text-danger">MÃ£ sá»‘ thuáº¿ pháº£i tá»‘i thiá»ƒu 10 kÃ½ tá»±</span>');
                                }
                                if($(this).hasClass('val-mail') && HRT.All.checkemail($(this).val()) == false){
                                    if($(this).siblings('span.text-danger').length == 0)
                                        $(this).after('<span class="text-danger">Email khÃ´ng há»£p lá»‡</span>');
                                }
        ...
        if (href.indexOf("?add=") != -1){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(!x){
                        alert('Sáº£n pháº©m báº¡n vá»«a mua Ä‘Ã£ háº¿t hÃ ng');
                    }
                    window.location = '/cart';
                },
                error: function(XMLHttpRequest, textStatus) {
    ...
    checkChangeInput: function(){
        $(".check_change").on("change paste keyup", function() {
            jQuery('.btn-save').html("LÆ°u thÃ´ng tin");
        });
    },
        ...
        $('.order-invoice-block .btn-save').on('click', function(e){
            ...
            $('#cartformpage .val-f').each(function(){
                if($(this).val() === ''){
                    ...
                    $(this).siblings('span.text-danger').remove();
                    setTimeout(function(){
                        jQuery('.btn-save').html("ÄÃ£ lÆ°u thÃ´ng tin");
                    }, 500);
                }
                if($(this).hasClass('val-n') && $(this).val().trim().length<10){
                    if($(this).siblings('span.text-danger').length == 0)
...
jQuery(document).ready(function(){
    HRT.All.checkCart();
    HRT.init();
    $('#buy-now-sticky').on('click', function(){
