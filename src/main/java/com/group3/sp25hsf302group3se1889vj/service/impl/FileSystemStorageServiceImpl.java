...
import com.group3.sp25hsf302group3se1889vj.config.StorageProperties;
import com.group3.sp25hsf302group3se1889vj.exception.StorageException;
import com.group3.sp25hsf302group3se1889vj.exception.StorageFileNotFoundException;
...
public class FileSystemStorageServiceImpl implements StorageService {
    ...
    public String store(MultipartFile file) {
        String extension = Objects.requireNonNull(FilenameUtils
    ...
    public String saveToTemp(MultipartFile file) {
        ...
        try {
            ...
            return String.join("/", "file/temps", filename);
        } catch (IOException e) {
